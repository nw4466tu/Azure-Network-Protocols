...
<br />
<p>
Next we are going to look at SSH traffic (which is a protocol that allows users to access a remote computer), so type SSH is the command line inside WireShark and hit enter. And then in PowerShell instead of pinging VM2, we're going to SSH (or secure shell) into it from VM1. 
<br />
<br />
<br />
<br />
